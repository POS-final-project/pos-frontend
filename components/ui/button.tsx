...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-amber-500 text-amber-950 border-amber-500/60 shadow-sm shadow-amber-600/15 hover:bg-amber-600 focus-visible:border-amber-600",
        outline:
          "border-slate-300 bg-white text-slate-700 hover:bg-slate-50 hover:border-slate-400 hover:text-slate-800",
        secondary:
          "bg-slate-100 text-slate-700 border-slate-200 hover:bg-slate-200 hover:text-slate-800",
        ghost:
          "text-slate-600 hover:bg-slate-100 hover:text-slate-800",
        destructive:
          "bg-red-50 text-red-600 border-red-200 hover:bg-red-100 hover:border-red-300 focus-visible:border-red-400/40 focus-visible:ring-red-300/20",
